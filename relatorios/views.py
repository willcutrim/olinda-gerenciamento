...
def relatorio(request):
    ...
    context = {
        ...
        'total_entradas_mensal': round(total_entradas_mensal, 2) if total_entradas_mensal != None else 0,
        'total_saidas_mensal': round(total_saidas_menasl, 2) if total_saidas_menasl != None else 0,
